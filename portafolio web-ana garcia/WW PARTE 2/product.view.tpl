...
2. Crea el controlador base Product en la carpeta src\Controllers\Products del proyecto.

Para crear el controlador, debemos crear un archivo llamado Product.php en la carpeta src\Controllers\Products del proyecto. El contenido de este archivo será el siguiente:
